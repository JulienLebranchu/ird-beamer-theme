...
\titlegraphictwo{
  \hspace{.1\textwidth}\includegraphics[height=1.25cm]{logo.pdf}
}%Leave blank if you want keep the space at the bottom without logo
...
\makethanks{Une science engagée pour un futur durable}
